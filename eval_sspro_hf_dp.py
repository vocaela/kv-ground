...
from sspro_report import sspro_evaluate as evaluate
...
class SsproHFLazyDataset(BaseLazyDataset):
    def __init__(self, 
                 data_dir, 
...
def main():
    ...
    # load dataset
    dataset = SsproHFLazyDataset(args.data_dir, sampling_rate=args.sampling_rate)
    eval(
        rank=rank,
