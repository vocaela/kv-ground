...
<p align="center">
  <a href="https://huggingface.co/vocaela/KV-Ground-8B-BaseGuiOwl1.5-0315"><img src="https://img.shields.io/badge/Hugging%20Face-8B--BaseGuiOwl1.5--0315-orange?logo=huggingface" alt="KV-Ground-8B-BaseGuiOwl1.5-0315"></a>
...
- [KV-Ground-8B-BaseGuiOwl1.5-0315](https://huggingface.co/vocaela/KV-Ground-8B-BaseGuiOwl1.5-0315) achieves 72.9, No.1 across all the models.
...
While optimized for high-resolution images, they maintains excellent performance on regular-resolution tasks as well, with 94.2 / 94.1 / 94.6 on ScreenSpot-V2.
...
- Impact of continue post-training on base models
  ...
  - Model only
    ...
    | **KV-Ground-8B-BaseGuiOwl1.5-0315*** | 72.9 (+2.4)    | 94.2 (+0.7)   | 67.9 (+3.2)  | 70.7 (+2.8)       | 39.5 (+1.2) |
  ...
  - With zoom-in strategy on ScreenSpot-Pro
    ...
    | **KV-Ground-8B-BaseGuiOwl1.5-0315** + Zoom-In* | 80.4 (+2.4)    |
...
- Comparision with top models (ranked by ScreenSpot-Pro)
  ...
  On ScreenSpot-Pro:
  - KV-Ground-8B-BaseGuiOwl1.5-0315: No.1 among all the models, and
...
- Comparision with agentic approaches on ScreenSpot-Pro
  ...
  - KV-Ground-8B-BaseGuiOwl1.5-0315 + Zoom-In: No.1 among all the systems
  - KV-Ground-4B-BaseGuiOwl1.5-0228 + Zoom-In: No.1 among systems w/ model under 4B, No.6 across all players

    | Model / Agentic                                | ScreenSpot-Pro | 
    |------------------------------------------------|:--------------:|
    | **KV-Ground-8B-BaseGuiOwl1.5-0315** + Zoom-In* | 80.4           |
