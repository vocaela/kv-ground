...
- [KV-Ground-8B-BaseGuiOwl1.5-0315](https://huggingface.co/vocaela/KV-Ground-8B-BaseGuiOwl1.5-0315) achieves 73.2, No.1 across all the models.
...
While optimized for high-resolution images, they maintains excellent performance on regular-resolution tasks as well, with 94.6 / 94.1 / 94.6 on ScreenSpot-V2.
...
- Impact of continue post-training on base models
  ...
  - With zoom-in strategy on ScreenSpot-Pro
    ...
    | **KV-Ground-8B-BaseGuiOwl1.5-0315** + Zoom-In* | 80.5 (+2.5)    |
